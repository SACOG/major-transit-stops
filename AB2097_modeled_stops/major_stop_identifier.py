...
class HQTransitStops:
    def __init__(self, run_folder, scen_yr, keep_all, addstops_csv=None, hf_th_mins=15):
        ...
        self.hifreq_ix_th = hf_th_mins # max headway, in minutes, at which a line can be considered hi frequency
